            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    onClick={() => setShowPreview(widget.id)}
                  ...
                  <button className="px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-xl text-sm font-semibold hover:from-gray-200 hover:to-gray-300 transition-all duration-300 border border-gray-300 flex items-center gap-2">
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 p-6 flex items-center justify-between">
              <div>
                <h3 className="text-2xl font-bold text-white mb-2">Preview del Widget</h3>
