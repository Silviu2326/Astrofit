                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => {
                        // Aquí se puede implementar la lógica para ver detalles de la campaña
                        alert(`Ver detalles de: ${campana.nombre}`);
                      }}
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => {
                        // Aquí se puede implementar la lógica para duplicar la campaña
                        alert(`Duplicando campaña: ${campana.nombre}`);
                      }}
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => {
                        // Aquí se puede implementar la lógica para archivar la campaña
                        alert(`Archivando campaña: ${campana.nombre}`);
                      }}
