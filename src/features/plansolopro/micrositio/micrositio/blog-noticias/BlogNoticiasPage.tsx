          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight">
                Blog <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-200 to-yellow-400">Noticias</span>
              </h1>
            </div>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl leading-relaxed">
              Gestiona el contenido de tu blog desde tu panel de entrenador
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Artículos Publicados</p>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Lectores Únicos</p>
