...
import { Download, FileText, FolderOpen, Sparkles, Upload, Search, X, File } from 'lucide-react';
...
const ContenidosDescargablesPage: React.FC = () => {
  ...
  const mockFiles: DownloadableFile[] = [
    {
      id: '1',
      name: 'Guía de Nutrición Completa.pdf',
      type: 'pdf',
      size: '2.4 MB',
      uploadDate: '2024-01-15',
      downloads: 1247,
      category: 'Nutrición',
      tags: ['nutrición', 'guía', 'completa'],
      url: '/downloads/guia-nutricion.pdf'
    },
    {
      id: '2',
      name: 'Plantilla de Rutinas de Entrenamiento.xlsx',
      type: 'xlsx',
      size: '1.2 MB',
      uploadDate: '2024-01-10',
      downloads: 892,
      category: 'Entrenamiento',
      tags: ['rutinas', 'plantilla', 'excel'],
      url: '/downloads/plantilla-rutinas.xlsx'
    },
    {
      id: '3',
      name: 'Manual de Bienestar Mental.docx',
      type: 'doc',
      size: '3.1 MB',
      uploadDate: '2024-01-08',
      downloads: 654,
      category: 'Bienestar',
      tags: ['bienestar', 'mental', 'manual'],
      url: '/downloads/manual-bienestar.docx'
    }
  ];
