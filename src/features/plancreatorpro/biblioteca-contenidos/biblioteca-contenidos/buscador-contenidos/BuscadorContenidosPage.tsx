...
import { Search, BookOpen, Video, Download, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 pb-12">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight">
              Buscador de <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-200 to-yellow-400">Contenidos</span>
            </h1>
          </div>

          {/* Descripción */}
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl leading-relaxed">
            Encuentra exactamente lo que necesitas con nuestro <span className="font-bold text-white px-2 py-1 bg-white/20 rounded-lg backdrop-blur-sm">buscador inteligente</span>
          </p>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <FiltrosAvanzados onApplyFilters={setActiveFilters} />
      </motion.div>
