...
import { createArticulo } from '../contenidosArticulosApi';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createArticulo({
        ...
        extracto: formData.content.substring(0, 200) + '...',
        categoria: formData.categories[0] || 'General',
        autor: 'Usuario Actual', // Esto debería venir del contexto de usuario
        tags: formData.tags,
        esPublico: true,
        imagen: formData.imageUrl || '/placeholder-product.svg'
      });
