        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight">
              Campañas de <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-200 to-yellow-400">Email</span>
            </h1>
          </div>

          {/* Descripción */}
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl leading-relaxed">
            Gestiona y supervisa todas tus <span className="font-bold text-white px-2 py-1 bg-white/20 rounded-lg backdrop-blur-sm">campañas de email marketing</span> desde un solo lugar
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 border border-white/20">
              ...
              <span className="text-sm font-semibold text-white">+15% Engagement</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 border border-white/20">
            ...
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 border border-white/20">
              ...
              <span className="text-sm font-semibold text-white">98% Entrega</span>
            </div>
          </div>
        </div>
      </motion.div>
