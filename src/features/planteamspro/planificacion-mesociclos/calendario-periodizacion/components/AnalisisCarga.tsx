  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Título */}
        <h3 className="text-xl font-bold text-gray-800 mb-2">Análisis de Cargas</h3>
        <p className="text-sm text-gray-600 mb-4">Distribución automática de cargas de entrenamiento</p>
        ...
        <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-200">
          ...
          <span className="text-xs font-semibold text-emerald-700">Análisis inteligente</span>
        </div>
      </div>
    </motion.div>
  );
