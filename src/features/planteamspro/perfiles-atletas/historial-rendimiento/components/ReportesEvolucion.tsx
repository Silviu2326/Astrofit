// src/features/historial-rendimiento/components/ReportesEvolucion.tsx
import React from 'react';
import { motion } from 'framer-motion';
import { FileText, TrendingUp } from 'lucide-react';

const ReportesEvolucion: React.FC = () => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-600 mb-4 leading-relaxed">
          Informes automáticos con análisis de progreso y tendencias
        </p>

        {/* Badge indicador */}
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-full border border-cyan-200">
            <span className="text-xs font-bold text-cyan-700">Automatizado</span>
          </div>
        </div>
...
export default ReportesEvolucion;
