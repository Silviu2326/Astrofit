// src/features/historial-rendimiento/components/ImpactoLesiones.tsx
import React from 'react';
import { motion } from 'framer-motion';
import { AlertTriangle, Activity } from 'lucide-react';

const ImpactoLesiones: React.FC = () => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-600 mb-4 leading-relaxed">
          Análisis de efectos en rendimiento y tiempos de recuperación
        </p>

        {/* Badge indicador */}
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 bg-gradient-to-r from-red-50 to-pink-50 rounded-full border border-red-200">
            <span className="text-xs font-bold text-red-700">Prevención</span>
          </div>
        </div>
...
export default ImpactoLesiones;
