// src/features/historial-rendimiento/components/BenchmarkingElite.tsx
import React from 'react';
import { motion } from 'framer-motion';
import { Award, TrendingUp } from 'lucide-react';

const BenchmarkingElite: React.FC = () => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-600 mb-4 leading-relaxed">
          Comparación automática con atletas de alto rendimiento
        </p>

        {/* Badge indicador */}
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-full border border-yellow-200">
            <span className="text-xs font-bold text-orange-700">Top Performance</span>
          </div>
        </div>
...
export default BenchmarkingElite;
