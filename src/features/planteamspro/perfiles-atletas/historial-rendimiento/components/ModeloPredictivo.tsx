// src/features/historial-rendimiento/components/ModeloPredictivo.tsx
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-600 mb-4 leading-relaxed">
          Proyecciones de rendimiento basadas en IA y tendencias históricas
        </p>

        {/* Badge indicador */}
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 bg-gradient-to-r from-purple-50 to-pink-50 rounded-full border border-purple-200">
            <span className="text-xs font-bold text-purple-700">Machine Learning</span>
          </div>
        </div>
