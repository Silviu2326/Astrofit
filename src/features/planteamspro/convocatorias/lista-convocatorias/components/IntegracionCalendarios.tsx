...
import { CalendarDays, Link2, ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-xl font-bold mb-2">Integración Calendarios</h3>
        <p className="text-violet-100 text-sm leading-relaxed">
          Sincroniza eventos con los calendarios personales de cada atleta.
        </p>

        <div className="mt-4 flex items-center gap-2">
          <Link2 className="w-4 h-4 text-purple-300" />
          <span className="text-xs font-semibold text-purple-300">Sincronización Total</span>
        </div>
      </div>
    </motion.button>
  );
...
export default IntegracionCalendarios;
