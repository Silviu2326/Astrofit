...
const CentroResultados: React.FC = () => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-600 mb-4 leading-relaxed">
          Validación automática y sistema de apelaciones.
        </p>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1 px-3 py-1 bg-orange-50 rounded-lg">
            ...
            <span className="text-xs font-bold text-orange-700">3 Pendientes</span>
          </div>
        </div>
      </div>
    </motion.div>
...
export default CentroResultados;
