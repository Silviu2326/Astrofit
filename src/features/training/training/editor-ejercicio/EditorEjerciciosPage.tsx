...
const EditorEjerciciosPage: React.FC = () => {
                ...
                <div className="divide-y divide-gray-100">
                  {ejerciciosFiltrados.map((ejercicio, index) => (
                    <motion.div
                      ...
                      onClick={() => handleEditEjercicio(ejercicio)}
                      className="grid grid-cols-12 gap-4 p-6 hover:bg-emerald-50/30 transition-colors duration-200 group cursor-pointer"
                    >
                      {/* Ejercicio */}
                      ...
                      <div className="col-span-1 flex items-center justify-end">
                        <div className="text-sm text-emerald-600 font-semibold group-hover:text-emerald-700">
                          Editar →
                        </div>
                      </div>
                    </motion.div>
...
export default EditorEjerciciosPage;
