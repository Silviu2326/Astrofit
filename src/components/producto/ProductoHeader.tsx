...
export const ProductoHeader: React.FC = () => {
  const navigate = useNavigate();

  return (
    <header className="bg-black/50 backdrop-blur-sm sticky top-0 z-50 border-b border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2 cursor-pointer hover:scale-105 transition-transform duration-300" onClick={() => navigate('/')}>
        ...
        <div className="flex items-center space-x-6">
          ...
          <button onClick={() => navigate('/precios')} className="hover:text-blue-400 transition-colors duration-300">Precios</button>
          <button
